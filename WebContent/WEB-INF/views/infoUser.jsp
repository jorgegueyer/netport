...
<html>
    ...
    <!-- Creamos los enlaces que nos permitir�n cambiar de p�gina. -->
        
        <h2>        	
        	<table border="1">
        		<td>Informaci�n del estudiante</td>            
        ...
        <form action="<%=pageContext.getRequest().getServletContext().getContextPath() %>/EstudianteServlet" method="POST">
            <table>            	
                <!-- A�adir los campos del formuario. Ya se aportan los botones del formulario.  -->
                 <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                    <label for="faddress">Direcci�n</label>
